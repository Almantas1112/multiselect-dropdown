  ...
  Widget _buildOption(int index, ThemeData theme) {
    ...
    return Ink(
      child: ListTile(
        title: Text(
          option.label,
          style: dropdownItemDecoration.labelStyle,
        ),
        trailing: !dropdownItemDecoration.shouldLead ? trailing : null,
        leading: dropdownItemDecoration.shouldLead ? trailing : null,
        dense: true,
        autofocus: true,
